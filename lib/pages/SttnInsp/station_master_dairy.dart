...
class _StationMasterDiaryState extends State<StationMasterDiary> {
  ...
  Future<void> getData() async {
    ...
    if (TiUtilities.inspmstr.cinsplist.contains('#22#')) {
      ...
      stationDarymod = await new StationMasterDiaryModel(
          SttnInspDtlsList.getSttnMasterList(), ['YES', 'YES','YES', 'YES','YES'],
          ['', '','', '',''],
          '');
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          onPressed: () async {
            ...
            if (_formKey.currentState.validate()) {
              TiUtilities.callSttnInspEntryWebService(context, json.encode(stationDarymod.toJson()), "saveSttnMstrDiary").then((res) {
