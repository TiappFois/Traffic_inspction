...
class AccidentRegister extends StatefulWidget {
  @override
  _AccidentRegisterState createState() => _AccidentRegisterState();
}

class _AccidentRegisterState extends State<AccidentRegister> {
  File imageFile = null ;
  ...
  static AccidentRegisterModel accidentregMod;
  ...
  Future<void> getData() async {
    ...
    if (TiUtilities.inspmstr.cinsplist.contains('#12#')) {
      ...
      try {
        ...
        var url= TiConstants.webServiceUrl +'getAccidentRgtr';
        ...
        if (response.statusCode == 200) {
          ...
          accidentregMod = await new AccidentRegisterModel(
              SttnInspDtlsList.getAcciList(), jsonResult['ynList1'],
              jsonResult['whyNoRsn'],
        ...
        ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Padding(
              ...
              child: Tooltip(
                message: SttnInspDtlsList.getAcciListDtls()[index],
                child: Card(
                  child: dropdowncls(
                      ...
                      whyNolst: accidentregMod.whyNoRsn,
                      regiType: "accireglang"),
                ),
              ),
            );
          },
  ...
  Future<String> _callSaveAccidentRegisterWebService(

      AccidentRegisterModel cautOrdReg) async {
    //log.d(alpa);
