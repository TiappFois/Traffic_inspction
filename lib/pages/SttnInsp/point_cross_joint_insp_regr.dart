...
class _PointCrossingJointInspectRegisterState
  ...
  Future<void> getData() async {
    ...
    if (TiUtilities.inspmstr.cinsplist.contains('#32#')) {
      ...
      pointcrossmod = await new PointCrossingJointInspectRegisterModel(
          SttnInspDtlsList.getPointCrossList(), ['YES','YES','YES','YES','YES','YES'],
          ['','','','','',''],
          '');
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          onPressed: () async {
            ...
            if (_formKey.currentState.validate()) {
              TiUtilities.callSttnInspEntryWebService(context, json.encode(pointcrossmod.toJson()), "savePointCrosReg").then((res) {
