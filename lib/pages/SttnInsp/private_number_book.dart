...
class _PrivateNumberBookState extends State<PrivateNumberBook> {
  ...
  Future<void> getData() async {
    ...
    if (TiUtilities.inspmstr.cinsplist.contains('#31#')) {
      ...
      privateNumbMod = await new PrivateNumberBookModel(
          SttnInspDtlsList.getPrivateNumbList(), ['SELECT','SELECT','SELECT'],
          ['','',''],
          '');
    ...
    return GestureDetector(
      ...
      child: new Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
            ...
            onPressed: () async {
              int selectedCount = 0 ;
              for(var i = 0 ; i < privateNumbMod.ynList1.length ; i++){
                if(privateNumbMod.ynList1[i] != "SELECT"){
                  selectedCount = 1 ;
                }
                else
                  privateNumbMod.ynList1[i] = '';
              ...
              if(selectedCount == 0){
                ...
                if (_formKey.currentState.validate()) {
                  TiUtilities.callSttnInspEntryWebService(
                      context, json.encode(privateNumbMod.toJson()),
                      "savePrvtNumbReg").then((res) {
      ...
      if (available) {
        ...
        _speech.listen(
          onResult: (val) => setState(() {
            ...
            privateNumbMod.rmrks1= rmrkController.text;
