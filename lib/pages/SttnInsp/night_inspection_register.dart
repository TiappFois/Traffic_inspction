...
class _NightInspectionRegisterState extends State<NightInspectionRegister> {
  ...
  Future<void> getData() async {
    ...
    if (TiUtilities.inspmstr.cinsplist.contains('#10#')) {
      ...
      nightInspMod = await new NightInspectionRegisterModel(
          SttnInspDtlsList.getNghtList(), ['YES', 'YES','YES', 'YES','YES'],
          ['', '','', '',''],
          '');
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          onPressed: () async {
            ...
            if (_formKey.currentState.validate()) {
              TiUtilities.callSttnInspEntryWebService(context, json.encode(nightInspMod.toJson()), "saveNightInapRgtrs").then((res) {
