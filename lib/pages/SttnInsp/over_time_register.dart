...
class _OverTimeRegisterState extends State<OverTimeRegister> {
  ...
  static OverTimeRegisterModel overtimeregmod;
  ...
  Future<void> getData() async {
    ...
    if (TiUtilities.inspmstr.cinsplist.contains('#11#')) {
      ...
      try {
        ...
        log.d("urlInputStringOverTime = " + urlInputString);
        var url= TiConstants.webServiceUrl +'getOVerTimeRgtrs';
        ...
        if (response.statusCode == 200) {
          ...
          overtimeregmod = await new OverTimeRegisterModel(
              SttnInspDtlsList.getOverTimeList(), jsonResult['ynList1'],
              jsonResult['whyNoRsn'],
      ...
      print ("In else of Over Time reg");
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: new Scaffold(
        ...
        bottomNavigationBar: TiUtilities.tiBottomNaviBar(context, "/accident_reg"),
        ...
        ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Padding(
              ...
              child: Tooltip(
                message: SttnInspDtlsList.getOverTimeListDtls()[index],
                child: Card(
                  child: dropdowncls(
                      ...
                      whyNolst: overtimeregmod.whyNoRsn,
                      regiType: "overtimereglang"),
                ),
              ),
            );
          },
