...
class _SickVechileRegisterState extends State<SickVechileRegister> {
  ...
  Future<void> getData() async {
    ...
    if (TiUtilities.inspmstr.cinsplist.contains('#18#')) {
      ...
      sickVehicleRegMod = await new SickVechileRegisterModel(
          SttnInspDtlsList.getSickVehicleList(), ['YES', 'YES','YES'],
          ['', '',''],
          '');
        ...
        floatingActionButton: FloatingActionButton.extended(
          ...
          onPressed: () async {
            ...
            if (_formKey.currentState.validate()) {
              TiUtilities.callSttnInspEntryWebService(context, json.encode(sickVehicleRegMod.toJson()), "saveSickVchlRgtr").then((res) {
